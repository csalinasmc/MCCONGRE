...
updateProgressColor = function () {
    ...
    $(document).ready(function () {
        ...
        gridConfig = {
            ...
            colNames: ["", "Situación", "COD_ENTIDAD", "Emisor", "F. Ingreso", "Expediente", "H. Ruta", "ENT_DESTINO", "Destino", "Derivación", "Asunto", "Origen", "nu_emi_", "nu_ann_", "nu_cor_emi_", "nu_ann_resp_", "nu_emi_resp_", "F. Venc.", "# Días", "P.L.", "N° Proyecto", "Estado Proyecto", "COD_TRAMITE_REF", "Tema", "NIDTEMA", "Rpta MC"],
            rowNum: 10,
            loadonce: true,
            mtype: "GET",
            rownumbers: true,
...
btnExportar = {
    ...
    onClickButton: function () {
        ...
        strHtmlexport += "<td style='font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 10px;font-weight: normal;color: black;vertical-align: middle;text-align: center;background-color: #dadada;text-decoration:none' >H. Ruta</td>";
        ...
        strHtmlexport += "<td style='font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 10px;font-weight: normal;color: black;vertical-align: middle;text-align: center;background-color: #dadada;text-decoration:none' >Derivación</td>";
...
function ProcesoBuscar(sw) {
    ...
    bindkeys = { "onEnter": OnEnterKey },
        ...
        { name: "COD_ENTIDAD", index: 'COD_ENTIDAD', width: 100, sorttype: 'string', searchoptions: { sopt: ['cn'] }, hidden: true },
            ...
            { name: "COD_TRAMITE", index: 'COD_TRAMITE', width: 50, align: 'center', sorttype: 'number', searchoptions: { sopt: ['cn']} },
            { name: "ENT_DESTINO", index: 'ENT_DESTINO', align: 'center', sorttype: 'string', searchoptions: { sopt: ['cn'] }, hidden: true },
            { name: "DESC_ENTIDAD_DESTINO", index: 'DESC_ENTIDAD_DESTINO', width: 60, align: 'left', sorttype: 'string', searchoptions: { sopt: ['cn']} },
            { name: "SDERIVACION", index: 'SDERIVACION', width: 60, align: 'left', sorttype: 'string', searchoptions: { sopt: ['cn']} },
             { name: "ASUNTO", index: 'ASUNTO', width: 200, align: 'left', sorttype: 'string', searchoptions: { sopt: ['cn']} },
            { name: "ORIGENSISTEMA", index: 'ORIGENSISTEMA', width: 80, align: 'left', sorttype: 'string', searchoptions: { sopt: ['cn']} },
